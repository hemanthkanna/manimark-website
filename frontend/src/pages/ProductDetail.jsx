...
import { getProductById, getProductsByCategory, discountPercent } from '../data/products'
        ...
        <section className="mx-auto max-w-[1366px] px-4 pt-8 pb-16 md:px-8">
          <Breadcrumb
            items={[
              ...
              ...(category ? [{ label: category.name, to: `/products/${category.slug}` }] : []),
              { label: product.name },
            ]}
          />
          ...
          <div className="mt-6 grid gap-8 md:grid-cols-2 md:gap-12">
            ...
            <div className="flex flex-col justify-center">
              ...
              <p className="mt-4 text-[15px] leading-relaxed text-brand-gray">{product.description}</p>

              {product.variants?.length > 0 && (
                <div className="mt-6">
                  <p className="text-sm font-semibold text-neutral-900">Pack size</p>
          ...
          {related.length > 0 && (
            <div className="mt-16">
              <p className="font-semibold text-neutral-900">You might also like</p>
